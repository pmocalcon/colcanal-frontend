 ...
 * del contrato, Jurídica). El texto de las cláusulas es fijo; las variables (partes, valor,
 * plazo, fechas, objeto) se diligencian y se prellenan desde la solicitud, el acta y la
 * designación. La firma la hace la Dra. Gloria en el flujo. Se guarda en data.contrato.
 *
        ...
        {!habilitada ? (
          ...
          <div className="doc bg-white border border-[#0a2a52] text-[12px] text-[#0a2a52] shadow-md">
            ...
            <div className="px-8 py-6">
              <p className="text-center font-bold mb-4">CONTRATO DE PRESTACIÓN DE SERVICIOS ENTRE {(f.contratante || '…').toUpperCase()} Y {(f.contratista || '…').toUpperCase()}</p>
              ...
              <div className="space-y-3 text-justify leading-relaxed text-[12px]">
                <p>
                  Entre los suscritos, a saber: <b>{f.contratante || '…'}</b> identificada con el NIT. {tx(f.contratanteNit)}, representada
                  legalmente por <b>{f.representanteLegal || '…'}</b>, identificada con la cédula de ciudadanía No. {tx(f.representanteCc)},
                  quien para los efectos del presente se denominará <b>LA CONTRATANTE</b>; y{' '}
                  <b>{f.contratista || '…'}</b>, mayor de edad, domiciliada en la ciudad de{' '}
                  <Inline value={f.ciudadContratista} onChange={(v) => set('ciudadContratista', v)} placeholder="ciudad" />,
                  {' '}identificada con cédula de Ciudadanía No. {tx(f.contratistaCc)}, y que para los efectos de este contrato se
                  denominará <b>LA CONTRATISTA</b>.
                </p>
                <p>Las partes se denominarán individualmente cada una como una "Parte" y conjuntamente como las "Partes".</p>
                <p>Las Partes han convenido celebrar el presente Contrato de Prestación de Servicios (en adelante "Contrato"), el cual se regirá por las siguientes cláusulas:</p>

                <p className="text-center font-bold pt-2">CLÁUSULAS</p>

                <Clausula titulo="PRIMERA. OBJETO:">
                  <Inline value={f.objetoClausula} onChange={(v) => set('objetoClausula', v)} placeholder="Prestación de servicios profesionales de apoyo a…" long />
                </Clausula>

                <Clausula titulo="SEGUNDA. VALOR DEL CONTRATO Y FORMA DE PAGO:">
                  El valor del presente contrato será de <Inline value={f.valorTotal} onChange={(v) => set('valorTotal', v)} placeholder="$0 M/L" />, los cuales serán
                  pagados a la CONTRATISTA vencido, en pagos mensuales de <Inline value={f.pagoMensual} onChange={(v) => set('pagoMensual', v)} placeholder="$0 M/L" />, los
                  cuales serán pagados al CONTRATISTA vencido.
                </Clausula>
                <p className="text-justify">
                  La fecha para el pago de la contraprestación mensual antes mencionada será en la semana siguiente a la radicación de la
                  factura, la cual será presentada por el Contratista dentro de los 5 primeros días calendario de cada mes. Serán descontados
                  los impuestos correspondientes según la norma vigente en Colombia. El pago será realizado en pesos Colombianos.
                </p>

                <Clausula titulo="TERCERA. DURACIÓN:">
                  El término de duración del presente contrato será de <Inline value={f.duracionClausula} onChange={(v) => set('duracionClausula', v)} placeholder="xxx (xx) meses" />
                  {' '}contados a partir del <Inline value={f.inicio} onChange={(v) => set('inicio', v)} placeholder="fecha de inicio" /> y hasta el{' '}
                  <Inline value={f.terminacion} onChange={(v) => set('terminacion', v)} placeholder="fecha final" />.
                </Clausula>
                <p className="text-justify">El presente Contrato podrá ser prorrogado de común acuerdo entre las Partes, bastando para el efecto acuerdo escrito.</p>

                <Clausula titulo="CUARTA. OBLIGACIONES DE LA CONTRATISTA:">Serán a cargo del Contratista las siguientes obligaciones:</Clausula>
                <Lista items={[
                ...
                <Clausula titulo="QUINTA. OBLIGACIONES DE LA CONTRATANTE:">Serán obligaciones de la Contratante las siguientes:</Clausula>
                <Lista items={[
                ...
                <Clausula titulo="SEXTA. TERMINACIÓN:">El presente Acuerdo podrá darse por terminado de manera anticipada por las siguientes causales:</Clausula>
                <Lista items={[
                ...
                <Clausula titulo="SÉPTIMA. PARTES INDEPENDIENTES:">Se deja expresa constancia que entre las Partes existe una simple relación comercial derivada del presente contrato, siendo cada una de ellas exclusiva responsable por el cumplimiento de sus obligaciones en materia laboral, civil, mercantil, tributaria, administrativa y, en general, por cualquier otra derivada de la ley.</Clausula>
                <p className="text-justify">Cada una de las Partes actuará por su propia cuenta, con absoluta autonomía e independencia técnica, directiva y financiera, y no estará sometido a subordinación laboral de la otra Parte.</p>
                <p className="text-justify">Ninguna de las Partes será responsable por daños y/o perjuicios indirectos o consecuenciales, incluyendo pérdida o interrupción de negocios, lucro cesante, o cualquier otro provenientes de reclamaciones, demandas o litigios que interpongan un tercero, salvo que los mismos provengan hasta de culpa leve de alguna de las partes.</p>

                <Clausula titulo="OCTAVA. CONFIDENCIALIDAD:">Con la suscripción del presente Acuerdo, las Partes reconocen que toda la información entregada por cada una de las Partes es confidencial, por lo que es propiedad exclusiva de quien la entrega, y que tal información confidencial la es revelada a la otra Parte única y exclusivamente para el desarrollo del presente Acuerdo y sólo podrá ser utilizada para los propósitos establecidos en el presente Acuerdo.</Clausula>
                <p className="text-justify">Las Partes se abstendrán de divulgar a terceros, en cualquier forma o modo, la información confidencial que le suministre la otra Parte y se obligan a tratar dicha información con la más absoluta confidencialidad, salvo que exista autorización previa, expresa y escrita de la parte reveladora caso en el cual sólo se revelará la información respectiva de acuerdo con las instrucciones que para el efecto indique la parte reveladora.</p>
                <p className="text-justify">Adicionalmente, las Partes se obligan a mantener la información confidencial debidamente protegida del acceso de terceros, con el fin de no permitir su conocimiento y/o manejo por parte de personas no autorizadas expresamente por la parte que hace la revelación.</p>
                <p className="text-justify">Las Partes se obligan a que las personas que se encuentren bajo su dirección cumplan con las obligaciones establecidas en la presente Cláusula. En consecuencia, de llegarse a acreditar incumplimiento, la parte incumplida se hace responsable por todos los daños y perjuicios que sufra la parte cumplida en el evento en que las personas que estén a cargo o bajo la dirección violen las obligaciones establecidas en la presente Cláusula.</p>
                <p className="text-justify">Al momento de la terminación del presente Acuerdo, o antes a solicitud de una de las Partes, las Partes deberán devolver toda la información confidencial que se encuentre en su poder, ya sea en medio escrito, magnético, digital y, en general, en cualquier otro sistema tecnológico con capacidad para almacenar información en cualquiera de sus formas.</p>
                <p className="text-justify">La información confidencial deberá ser tratada como tal y debidamente resguardada por las Partes durante el término de vigencia del presente Acuerdo y a partir de la fecha en que ésta le es entregada. Las obligaciones de no revelar, divulgar, exhibir, mostrar, comunicar, utilizar y/o emplear la Información Confidencial en beneficio propio y/o en el de terceros adquiridas por cada Parte no se entenderán extinguidas por el vencimiento del término de duración del presente Acuerdo o por lo mismo continuarán vigentes por un término de dos (2) años contados a partir de la fecha de terminación del presente Acuerdo.</p>
                <p className="text-justify">En el evento en que una de las Partes, en desarrollo o por mandato de una ley, decreto, sentencia y/u orden de autoridad competente en ejercicio de sus funciones legales, se vea obligada a revelar o divulgar la información confidencial que le ha sido entregada por la otra Parte, se obliga a dar aviso por escrito de ello a la otra Parte dentro de los tres (3) días hábiles siguientes a que tenga conocimiento de esta obligación de revelación, para que ésta pueda tomar las medidas necesarias para (i) proteger su información confidencial y (ii) atenuar los efectos de tal divulgación.</p>

                <Clausula titulo="NOVENA. LIMITACIÓN DE RESPONSABILIDAD:">Las Partes aceptan indemnizar, defender y eximir de responsabilidad a la otra Parte, sus afiliados y sus respectivos funcionarios, directores, empleados y agentes, de y contra cualquier reclamo, demanda, pérdida, daño, responsabilidad, causa de acción, juicios o costos y gastos de toda naturaleza (incluidos los honorarios y gastos de abogados) que surjan del incumplimiento de los términos del presente contrato.</Clausula>
                <p className="text-justify">En ningún caso la responsabilidad de la Contratista por cualquier causa y cualquier daño que se dé o en relación con este Contrato excederá, en conjunto, los honorarios totales pagaderos por la CONTRATANTE a la CONTRATISTA por los servicios prestados durante un período de doce (12) meses inmediatamente anteriores a la fecha en que surgió dicha responsabilidad.</p>

                <Clausula titulo="DÉCIMA. PROPIEDAD INTELECTUAL:">Toda la información, documentos, invenciones, los derechos de propiedad intelectual, marcas, derechos de autor, derechos privados o know-how confidencial o procesos y demás elementos que protege la propiedad intelectual y provienen de cada una de las Partes son de propiedad de quien las entrega y le deben ser regresados de manera oportuna cuando así lo solicite, al igual que todas las copias que se hayan hecho. En ningún momento debe entenderse que el acceso que va a tener, tiene o tuvo la otra Parte o sus dependientes a la información del algún tipo de derecho sobre la misma. Así, las Partes se obligan a la terminación de esta relación, y en todo caso en cualquier momento cuando así lo exija la otra Parte devolverá todos y cada uno de los documentos físicos o electrónicos, y soportes que comprenden la información Confidencial. Esta obligación de entregar incluye los originales y las copias de todos y cada uno de ellos, así como los disquetes o cintas y demás soportes materiales en que pueda estar impresa o grabada la información, se encuentre ésta en su poder o en el de sus subalternos.</Clausula>

                <Clausula titulo="DÉCIMA PRIMERA. INTEGRIDAD:">Este Contrato es integral entre las Partes, por tanto, sustituye cualquier otro tipo de acuerdo o convenio, escrito o verbal que pudieren haber celebrado con anterioridad.</Clausula>

                <Clausula titulo="DÉCIMA SEGUNDA. DIVISIBILIDAD:">Si alguna cláusula del presente Contrato es declarada nula, ilegal o sin efectos, las demás cláusulas continuarán de todas formas vigentes y dicha cláusula o disposición inválida, ilegal o sin efectos deberá ser modificada por las respectivas Partes según sea necesario para ajustarla a la ley aplicable.</Clausula>

                <Clausula titulo="DÉCIMA TERCERA. AUTORIZACIÓN SOBRE TRATAMIENTO DE DATOS PERSONALES:">Las Partes autorizan de manera libre, previa, clara, expresa, voluntaria e informada a la otra Parte para que se efectúe operaciones sobre sus datos personales tales como recolección, almacenamiento, uso, circulación o supresión, para los fines relacionados con el objeto de este acuerdo, incluidas auditorías, interventorías, procesos estadísticos o revisión por los asesores legales externos, bajo los criterios establecidos en la Ley 1581 de 2012, el Decreto Reglamentario 1377 de 2013 y demás normas que regulen el tema y la política sobre uso de datos personales.</Clausula>

                <Clausula titulo="DÉCIMA CUARTA. SUPRESIÓN DE DATOS:">La titular tiene el derecho, en todo momento, a solicitar a la otra Parte, la eliminación de sus datos personales cuando:</Clausula>
                <Lista items={[
                ...
                <p className="text-justify"><b>PARÁGRAFO:</b> Es importante tener en cuenta que el derecho de supresión no es absoluto y el responsable puede negar el ejercicio del mismo cuando:</p>
                <Lista items={[
                ...
                <p className="text-justify">Todas las notificaciones, requerimientos o cualquier otro tipo de comunicación se entenderán recibidas en la fecha de su recepción si se recibe antes de las 5:00 pm en el lugar de recepción y si dicho día es un día hábil. En caso contrario, las notificaciones, requerimientos o comunicaciones se entenderán recibidas el siguiente día hábil en el lugar de notificación del destinatario.</p>

                <Clausula titulo="DÉCIMA NOVENA. ORIGEN DE INGRESOS:">Las Partes, declaran que tanto los recursos utilizados en la ejecución del presente Acuerdo, así como sus ingresos, provienen de actividades lícitas. Igualmente declaran que no se encuentran en registros negativos en listas de prevención de lavado de activos y/o financiación al terrorismo, nacionales o internacionales, ni incurren en una de las categorías de lavado de activos (conversión o movimiento) y que en consecuencia se obliga a responder frente a la otra parte por todos los perjuicios que le llegaran a causar como consecuencia de la falta de veracidad de esta afirmación. En igual sentido, la parte que incumpliere responderá ante la parte cumplidora o algún tercero afectado por los perjuicios causados. Las Partes declaran igualmente, que su conducta se ajusta a la ley y a la ética. Para todos los efectos el "lavado de dinero" es el conjunto de procedimientos usados para cambiar la identidad del dinero obtenido ilegalmente, a fin de que aparente haber sido obtenido de fuentes legítimas. Estos procedimientos incluyen disimular la procedencia y propiedad verdadera de los fondos.</Clausula>

                <Clausula titulo="VIGÉSIMA. MODIFICACIONES:">Este contrato no podrá ser modificado, alterado o enmendado salvo autorización por escrito debidamente suscrito por los representantes debidamente autorizados de cada una de las Partes.</Clausula>

                <Clausula titulo="VIGÉSIMA PRIMERA. CESIÓN:">Las Partes no podrán ceder, parcial ni totalmente, la ejecución del presente contrato a un tercero sin la autorización previa expresa y por escrito de la otra Parte.</Clausula>

                <Clausula titulo="VIGÉSIMA SEGUNDA. LEGISLACIÓN APLICABLE Y SOLUCIÓN DE CONTROVERSIAS:">El presente Contrato se celebra y ejecuta de acuerdo con las disposiciones legales vigentes y aplicables a la República de Colombia.</Clausula>
                <p className="text-justify">Todos los conflictos o diferencias que surjan entre las Partes en la ejecución o liquidación del presente Contrato, salvo las excepciones legales, serán dirimidos mediante procedimientos de autocomposición tales como la negociación directa o la mediación. Para tal efecto, las Partes dispondrán de treinta (30) días calendario contados a partir de la fecha en que cualquiera de ellas requiera a la otra por escrito en tal sentido, término que podrá ser prorrogado de común acuerdo. Pasada la etapa de acuerdo directo sin que las Partes hayan llegado a un acuerdo o solución, las diferencias serán resueltas por medio del mecanismo de amigable composición de conformidad con el reglamento que para tal efecto tenga previsto el Centro de Arbitraje y Conciliación de la Cámara de Comercio de Bogotá. La decisión del amigable componedor será vinculante para las Partes. La decisión será tomada por un único amigable componedor que será elegido por el Centro de Arbitraje y Conciliación de la Cámara de Comercio de Bogotá.</p>
                <p className="text-justify">Si después de haber agotado los anteriores mecanismos, siguen existiendo controversias entre las Partes, se convocará un tribunal de arbitramento de conformidad con las siguientes reglas:</p>
                <Lista items={[
                ...
                {/* Firmas */}
                <p className="pt-6">
                  Las partes suscriben el presente documento, el{' '}
                  <Inline value={f.fechaSuscripcion} onChange={(v) => set('fechaSuscripcion', v)} placeholder="fecha de suscripción" />.
                </p>
                ...
                <div className="pt-8 text-[11px] space-y-1">
                  <div className="flex gap-2"><span className="font-semibold whitespace-nowrap">Elaboró:</span><Inline value={f.elaboro} onChange={(v) => set('elaboro', v)} placeholder="Nombre - Cargo" /></div>
                  <div className="flex gap-2"><span className="font-semibold whitespace-nowrap">Proyectó y revisó:</span><Inline value={f.proyectoReviso} onChange={(v) => set('proyectoReviso', v)} placeholder="Nombre - Cargo" /></div>
                </div>
              </div>
            </div>
          </div>
...
function Clausula({ titulo, children }: { titulo: string; children: React.ReactNode }) {
  return (
    <p className="text-justify"><b>{titulo}</b> {children}</p>
  );
}
...
function Inline({ value, onChange, placeholder, long }: { value: string; onChange: (v: string) => void; placeholder?: string; long?: boolean }) {
  return (
    <input
      value={value}
      onChange={(e) => onChange(e.target.value)}
      placeholder={placeholder}
      size={long ? undefined : Math.max((value || placeholder || '').length, 6)}
      className={(long ? 'w-full ' : '') + 'bg-transparent outline-none border-b border-dotted border-[hsl(var(--canalco-neutral-300))] focus:border-[hsl(var(--canalco-primary))] text-[12px] placeholder:italic placeholder:text-[hsl(var(--canalco-neutral-400))]'}
    />
  );
}
