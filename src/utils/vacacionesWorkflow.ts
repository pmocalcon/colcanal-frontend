...
export const estadoLabel = (estado: string) => VACACIONES_ESTADOS[estado as VacacionesEstado]?.label ?? estado;
export const estadoBadgeClass = (estado: string) =>
  TONE_CLASSES[VACACIONES_ESTADOS[estado as VacacionesEstado]?.tone ?? 'gray'];
