...
export const quimbayaConfig: ActaConfig = {
  ...
  consideraciones: [
    ...
    // B
    'Que conforme con el artículo 315 de la Carta Política de Colombia, corresponde a los alcaldes cumplir y hacer cumplir la Constitución, la ley, los decretos del gobierno, las ordenanzas, los acuerdos de los concejos y dirigir la acción administrativa del municipio; asegurar el cumplimiento de las funciones y la prestación de los servicios a su cargo, en concordancia con el artículo 91 de la Ley 136 de 1994 modificado por el artículo 29 de la Ley 1551 de 2012.',
    // C
    ...
    // D
    'Que, en cumplimiento de sus competencias, y previo trámite de un proceso licitatorio adelantado con arreglo a la Ley 80 de 1993, el día 25 de febrero de 2015 se suscribió el Contrato de Concesión No. 001 de 2015, entre el Municipio de Quimbaya y la Unión Temporal Alumbrado Público Quimbaya, cuyo objeto es "...la atención del Servicio de Alumbrado Público en el Municipio De Quimbaya en lo relativo a Inversión, Modernización, Rehabilitación, Reposición del sistema de alumbrado público, operación, mantenimiento y expansión del servicio y la operación del sistema de Alumbrado Público- SALP- correspondiente incluyendo el suministro, instalaciones, reemplazo, renovación, expansión y mantenimiento de las luminarias y de los accesorios electrónicos y en fin todo lo inherente y relacionado con el servicio de alumbrado público, de conformidad con los requisitos y condiciones establecidas en los pliegos de condiciones de la licitación pública No.003 de 2014, y la propuesta presentada por el concesionario dando total cumplimiento a todas las especificaciones técnicas, condiciones y obligaciones estipuladas y emanadas de este contacto, la oferta y de los términos de referencia de la licitación. el concesionario suministrará los bienes y prestará los servicios en las cantidades y en la forma establecida en los documentos que hacen parte del presente contrato.", incluyendo el suministro, instalación, reemplazo, renovación, expansión y mantenimiento de las luminarias y de los accesorios eléctricos, y en fin todo lo inherente y relacionado con el servicio de alumbrado público, de conformidad con los requisitos y condiciones establecidas en el pliego de condiciones del proceso Licitatorio.',
    // E
    'El 01 de abril de 2015 se suscribió acta de inicio del contrato No. 001-2015, cuyo plazo de ejecución es de 20 años y que a la fecha se encuentra cumplido y en ejecución.',
    // F
    'Que con la presente actuación la Entidad pretende dar cumplimiento a lo contemplado en el artículo 3 de la Ley 80 de 1993, el cual consagra que los servidores públicos tendrán en consideración que al celebrar contratos y con la ejecución de los mismos, las entidades han de buscar el cumplimiento de los fines estatales, la continua y eficiente prestación de los servicios públicos y la efectividad de los derechos e intereses de los administrados que colaboran con ellas en la consecución de dichos fines; siendo de igual manera un desarrollo del principio de economía.',
    // G
    'Que en consideración a la celebración del Contrato de Concesión en cita, y teniendo en cuenta la orden legal contenida en el artículo 29 de la Ley 1150 de 2007 antes mencionada, el Municipio seleccionó y contrató una interventoría idónea, de forma que, durante todo el plazo de la concesión, se garantice el servicio obligatorio conexo a la Concesión, a que se refiere la Ley en mención, y que pretende dotar al ente territorial de una auditoría técnica que permita controlar el adecuado cumplimiento del contrato de concesión.',
    // H
    'Que conforme a lo descrito en el literal que precede, el Municipio de Quimbaya - Quindío celebró Contrato de Interventoría No.01 de 2015 el día 05 de mayo de 2015 con el contratista INGENIERÍA Y SOPORTE S.B.Z S.A.S cuyo objeto es: "REALIZAR LA INTERVENTORÍA TÉCNICA, ADMINISTRATIVA, JURÍDICA Y FINANCIERA A LOS CONTRATOS DERIVADOS DE LOS PROCESOS DE CONTRATACIÓN QUE SE ADELANTEN EN EL MUNICIPIO DE QUIMBAYA CORRESPONDIENTES AL SUMINISTRO DE ENERGÍA ELÉCTRICA NECESARIA PARA EL SERVICIO DE ALUMBRADO PÚBLICO DEL MUNICIPIO DE QUIMBAYA, EL CONTRATO DE CONCESIÓN No 01 DE 2015 SUSCRITO PARA LLEVAR A CABO LA INVERSIÓN, MODERNIZACIÓN, REHABILITACIÓN, OPERACIÓN, MANTENIMIENTO, REPOSICIÓN DEL SISTEMA DE ALUMBRADO PÚBLICO MUNICIPAL, ADMINISTRACIÓN Y GESTIÓN DEL SERVICIO Y LA ADMINISTRACIÓN DE LOS RECURSOS DEL IMPUESTO DE ALUMBRADO PÚBLICO MUNICIPAL, BAJO LA MODALIDAD DE FIDUCIA DE ADMINISTRACIÓN Y PAGOS".',
    // I
    'Que el artículo 350 del Estatuto Tributario Ley 1819 de 2016 dispone: "El impuesto de alumbrado público como actividad inherente al servicio de energía eléctrica se destina exclusivamente a la prestación, mejora, modernización y ampliación de la prestación del servicio de alumbrado público, incluyendo el suministro, administración, operación, mantenimiento, expansión y desarrollo tecnológico asociado. PARÁGRAFO. Las Entidades Territoriales en virtud de su autonomía, podrán complementar la destinación del impuesto a la actividad de iluminación ornamental y navideña en los espacios públicos".',
    // J
