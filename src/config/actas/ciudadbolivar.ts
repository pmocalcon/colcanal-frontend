...
export const ciudadBolivarConfig: ActaConfig = {
  ...
  consideraciones: [
    ...
    'Que EL MUNICIPIO abrió proceso de licitación pública No 001-2022 de fecha 14 de enero de 2022 para contratar mediante el sistema de CONCESIÓN la prestación del servicio de Inversión, Administración, Operación, Mantenimiento, Reposición, Expansión y Desarrollo Tecnológico asociado al sistema de alumbrado público del Municipio de Ciudad Bolívar, suministrando el CONCESIONARIO a pleno costo los elementos, y asumiendo en fin, todo lo inherente y relacionado con el servicio de Alumbrado Público en todo el territorio del Municipio, a cambio de la remuneración pactada por las partes.',
  ...
  clausulas: [
    ...
    {
      title: 'SEGUNDO',
      content: 'El Contratista Concesionario ejecutará los proyectos de expansión y la infraestructura de alumbrado público de los sectores del Municipio de Ciudad Bolívar, de conformidad con el presupuesto anexo y el valor total aprobado por la Contratante y la Interventoría, dentro del plazo fijado.',
    },
    {
