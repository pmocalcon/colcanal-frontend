...
export const pueblorricoConfig: ActaConfig = {
  ...
  docFields: {
    ...
    intCargo: 'Director de Interventoría del Contrato de Concesión',
  },
  ...
  consideraciones: [
    ...
    'Que EL MUNICIPIO abrió proceso de licitación pública No 002 de 2022 para contratar mediante el sistema de CONCESION, la prestación de servicio de Inversión, Administración, Operación, Mantenimiento, Reposición, Expansión y Desarrollo Tecnológico asociado al sistema de alumbrado público del Municipio de Pueblorrico, suministrando el CONCESIONARIO a pleno costo los elementos, y asumiendo en fin, todo lo inherente y relacionado con el servicio de Alumbrado Público en todo el territorio del Municipio, a cambio de la remuneración pactada por las partes.',
    ...
    'Que, adjudicado el proceso de licitación, EL MUNICIPIO y EL CONCESIONARIO firmaron el contrato de concesión No. 01 de 2022 de fecha 11 agosto de 2022.',
    ...
    'Que con fundamento en lo anterior, las partes',
  ],
  ...
  clausulas: [
    ...
    {
      title: 'SEGUNDA - VALOR DEL PROYECTO',
      content: 'El valor total del proyecto de la expansión es de VEINTITRÉS MILLONES QUINIENTOS CINCUENTA Y UN MIL SEISCIENTOS CINCUENTA Y OCHO PESOS MONEDA LEGAL ($23.551.658,28) M/CTE así:\n\nPARAGRAFO—FUENTE DE FINANCIAMIENTO: El proyecto de expansión para iluminación del sistema de alumbrado público en el municipio de Pueblorrico se ejecutará con los excedentes del recaudo de Alumbrado Público, determinados con corte a 31 de agosto de 2024.',
    },
  ],
};
